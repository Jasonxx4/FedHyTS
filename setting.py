...
class SetParameter:
    def __init__(self):
        ...
        self.gtraj = {
            ...
            'hyp_beta': 1.0,      
            'hyp_factor_dim': 16, 
            'use_fully_hyperbolic': False,
            'hyp_gcn_type': 'hierarchical_hyperbolic',  
        ...
        if str(self.distance_type) == "TP":
            ...
            self.coe = 8*2
        elif str(self.distance_type) == "NetERP":
            self.coe = 8*4
        elif str(self.distance_type) == "NetDTW":
            self.coe = 8*4
        else:
            self.coe = 8*2  
        allowed_dis = {'TP', 'DITA', 'discret_frechet', 'LCRS', 'NetERP', 'NetDTW'}
